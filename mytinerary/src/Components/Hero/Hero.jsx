    ...
    <section className='bg-transparent rounded-xl'>
      <div className='grid max-w-screen-xl h-[90vh] md:h-auto lg:h-[90vh] px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12'>
        <div className='lg:mr-auto place-self-center lg:col-span-7 flex flex-col items-center lg:items-start'>
          ...
          <NavLink to={"/cities"} className='inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-brand-default hover:bg-brand-hoverD focus:ring-4 focus:ring-white'>Get started <ArrowRight className='w-8 h-8 ms-1' color="#f7f7f7" /> </NavLink>
        </div>
        <div className='mt-4 lg:mt-0 lg:col-span-5 lg:flex '>
          <img className="rounded-xl object-cover" src='../../../Images/travel.jpg' alt='mockup' />
        </div>
      </div>
    </section>
  );
